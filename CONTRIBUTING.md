...
issue](https://github.com/cisagov/vpn-config-gen/issues) in
...
request](https://github.com/cisagov/vpn-config-gen/pulls),
...
```console
cd vpn-config-gen
pyenv virtualenv <python_version_to_use> vpn-config-gen
pyenv local vpn-config-gen
